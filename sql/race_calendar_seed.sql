...
-- Source: FIA / Formula1.com official 2026 calendar (confirmed June 2025)
--
-- KEY CHANGES FROM ESTIMATED CALENDAR:
--   - All dates corrected to official confirmed dates
--   - Imola REMOVED (dropped from 2026 calendar)
--   - Madrid ADDED as R16 (new street circuit debut)
--   - Sprint weekends corrected: China, Miami, Canada, GB, Netherlands, Singapore
--   - Canada moved earlier (after Miami, May 22-24)
...
USING (
  ...
  -- R4: Bahrain  Apr 10-12  (race Sun Apr 12)
  (4,'Bahrain Grand Prix','Bahrain International Circuit','Sakhir','Bahrain','BH','🇧🇭',
   '2026-04-10'::DATE,'2026-04-10'::DATE,'2026-04-11'::DATE,'2026-04-11'::DATE,NULL,NULL,'2026-04-12'::DATE,
   '2026-04-12 15:00:00 +00:00'::TIMESTAMP_TZ,5.412,57,'1:31.447','De Vries',2023,3,FALSE,FALSE,2026),

  -- R5: Saudi Arabia  Apr 17-19  (race Sun Apr 19)
  (5,'Saudi Arabian Grand Prix','Jeddah Corniche Circuit','Jeddah','Saudi Arabia','SA','🇸🇦',
   '2026-04-17'::DATE,'2026-04-17'::DATE,'2026-04-18'::DATE,'2026-04-18'::DATE,NULL,NULL,'2026-04-19'::DATE,
   '2026-04-19 17:00:00 +00:00'::TIMESTAMP_TZ,6.174,50,'1:30.734','Leclerc',2022,3,FALSE,FALSE,2026),

  -- R6: Miami  May 1-3  (race Sun May 3)  SPRINT
  (6,'Miami Grand Prix','Miami International Autodrome','Miami','United States','US','🇺🇸',
   '2026-05-01'::DATE,'2026-05-01'::DATE,NULL,'2026-05-02'::DATE,'2026-05-01'::DATE,'2026-05-02'::DATE,'2026-05-03'::DATE,
   '2026-05-03 19:00:00 +00:00'::TIMESTAMP_TZ,5.412,57,'1:29.708','Verstappen',2023,3,TRUE,FALSE,2026),

  -- R7: Canada  May 22-24  (race Sun May 24)  SPRINT
  (7,'Canadian Grand Prix','Circuit Gilles Villeneuve','Montreal','Canada','CA','🇨🇦',
  ...
  -- R8: Monaco  Jun 5-7  (race Sun Jun 7)
  (8,'Monaco Grand Prix','Circuit de Monaco','Monte Carlo','Monaco','MC','🇲🇨',
  ...
  -- R9: Spain (Barcelona)  Jun 12-14  (race Sun Jun 14)
  (9,'Spanish Grand Prix','Circuit de Barcelona-Catalunya','Barcelona','Spain','ES','🇪🇸',
  ...
  -- R10: Austria  Jun 26-28  (race Sun Jun 28)
  (10,'Austrian Grand Prix','Red Bull Ring','Spielberg','Austria','AT','🇦🇹',
  ...
  -- R11: Great Britain  Jul 3-5  (race Sun Jul 5)  SPRINT
  (11,'British Grand Prix','Silverstone Circuit','Silverstone','United Kingdom','GB','🇬🇧',
  ...
  -- R12: Belgium  Jul 17-19  (race Sun Jul 19)
  (12,'Belgian Grand Prix','Circuit de Spa-Francorchamps','Spa','Belgium','BE','🇧🇪',
  ...
  -- R13: Hungary  Jul 24-26  (race Sun Jul 26)
  (13,'Hungarian Grand Prix','Hungaroring','Budapest','Hungary','HU','🇭🇺',
  ...
  -- R14: Netherlands  Aug 21-23  (race Sun Aug 23)  SPRINT — final Dutch GP
  (14,'Dutch Grand Prix','Circuit Zandvoort','Zandvoort','Netherlands','NL','🇳🇱',
  ...
  -- R15: Italy (Monza)  Sep 4-6  (race Sun Sep 6)
  (15,'Italian Grand Prix','Autodromo Nazionale Monza','Monza','Italy','IT','🇮🇹',
  ...
  -- R16: Madrid  Sep 11-13  (race Sun Sep 13)  NEW VENUE
  (16,'Madrid Grand Prix','Madrid Street Circuit','Madrid','Spain','ES','🇪🇸',
  ...
  -- R17: Azerbaijan  Sep 24-26  (race SAT Sep 26 — Saturday race)
  (17,'Azerbaijan Grand Prix','Baku City Circuit','Baku','Azerbaijan','AZ','🇦🇿',
  ...
  -- R18: Singapore  Oct 9-11  (race Sun Oct 11)  SPRINT
  (18,'Singapore Grand Prix','Marina Bay Street Circuit','Singapore','Singapore','SG','🇸🇬',
  ...
  -- R19: United States  Oct 23-25  (race Sun Oct 25)
  (19,'United States Grand Prix','Circuit of The Americas','Austin','United States','US','🇺🇸',
  ...
  -- R20: Mexico  Oct 30-Nov 1  (race Sun Nov 1)
  (20,'Mexico City Grand Prix','Autodromo Hermanos Rodriguez','Mexico City','Mexico','MX','🇲🇽',
  ...
  -- R21: Brazil  Nov 6-8  (race Sun Nov 8)
  (21,'São Paulo Grand Prix','Autodromo Jose Carlos Pace','São Paulo','Brazil','BR','🇧🇷',
  ...
  -- R22: Las Vegas  Nov 19-21  (race SAT Nov 21 — Saturday race)
  (22,'Las Vegas Grand Prix','Las Vegas Strip Circuit','Las Vegas','United States','US','🇺🇸',
  ...
  -- R23: Qatar  Nov 27-29  (race Sun Nov 29)
  (23,'Qatar Grand Prix','Lusail International Circuit','Lusail','Qatar','QA','🇶🇦',
  ...
  -- R24: Abu Dhabi  Dec 4-6  (race Sun Dec 6)
  (24,'Abu Dhabi Grand Prix','Yas Marina Circuit','Abu Dhabi','United Arab Emirates','AE','🇦🇪',
